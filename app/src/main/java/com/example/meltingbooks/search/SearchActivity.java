...
public class SearchActivity extends AppCompatActivity {
    ...
    private RadioGroup layoutBookOptions, layoutUserOptions, layoutGroupOptions, layoutHashtagOptions;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       userId = prefs.getInt("userId", -1);
        ...
        layoutUserOptions = findViewById(R.id.layout_user_options);
        layoutGroupOptions = findViewById(R.id.layout_group_options);
        layoutHashtagOptions = findViewById(R.id.layout_hashtag_options);
    ...
    private void showRadioGroupForTab(String tab) {
        ...
        layoutUserOptions.setVisibility(tab.equals("user") ? View.VISIBLE : View.GONE);
        layoutGroupOptions.setVisibility(tab.equals("group") ? View.VISIBLE : View.GONE);
        layoutHashtagOptions.setVisibility(tab.equals("hashtag") ? View.VISIBLE : View.GONE);
    }
