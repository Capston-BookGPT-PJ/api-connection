...
import com.example.meltingbooks.profile.FollowListActivity;
...
public class FollowUsersAdapter extends RecyclerView.Adapter<FollowUsersAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public FollowUsersAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull FollowUsersAdapter.ViewHolder holder, int position) {
