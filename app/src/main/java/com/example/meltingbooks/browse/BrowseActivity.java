...
// ⭐ FeedResponse → FeedItem 매핑
    ...
    private void setupTabStyle() {
        ...
        List<TextView> tabs = List.of(popularBooks, popularTags, popularUsers);
        ...
        View.OnClickListener tabClickListener = v -> {
            ...
            selected.setBackground(ContextCompat.getDrawable(this, R.drawable.round_background_20));
            selected.setBackgroundTintList(
                    android.content.res.ColorStateList.valueOf(
                            android.graphics.Color.parseColor("#A6FFBCE1")
                    )
            );
            ...
            if (v == popularBooks) {
                ...
                findViewById(R.id.hashtagsLayout).setVisibility(View.GONE);
                findViewById(R.id.usersLayout).setVisibility(View.GONE);
            } else if (v == popularTags) {
                findViewById(R.id.booksAndReviewsLayout).setVisibility(View.GONE);
                findViewById(R.id.hashtagsLayout).setVisibility(View.VISIBLE);
                findViewById(R.id.usersLayout).setVisibility(View.GONE);
            } else if (v == popularUsers) {
                findViewById(R.id.booksAndReviewsLayout).setVisibility(View.GONE);
                findViewById(R.id.hashtagsLayout).setVisibility(View.GONE);
                findViewById(R.id.usersLayout).setVisibility(View.VISIBLE);
            }
        ...
        // ✅ 하나의 리스너로 통합해 연결
        popularBooks.setOnClickListener(tabClickListener);
        popularTags.setOnClickListener(tabClickListener);
        popularUsers.setOnClickListener(tabClickListener);

        // 초기 선택값
        popularBooks.performClick();
    }
