...
public class GroupResponseAdapter extends RecyclerView.Adapter<GroupResponseAdapter.GroupViewHolder> {

    public interface OnItemClickListener {
        void onItemClick(GroupResponse groupResponse);
    }
    ...
    public GroupResponseAdapter(Context context, List<GroupResponse> groupList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull GroupViewHolder holder, int position) {
        GroupResponse group = groupList.get(position);
    ...
    public static class GroupViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final GroupResponse group, final OnItemClickListener listener) {
    ...
    // 데이터 갱신
    public void updateData(List<GroupResponse> newGroupList) {
        groupList.clear();
    ...
    // 새로운 그룹 추가
    public void addItem(GroupResponse group) {
