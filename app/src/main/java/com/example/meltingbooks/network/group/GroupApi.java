...
public interface GroupApi {
    ...
    Call<GroupFeedResponse> getGroupFeed(
            @Path("groupId") int groupId,
            @Query("page") int page,
            @Query("size") int size
    );
    ...
    Call<ApiResponse<PostSingleResponse>> createPost(
    ...
    Call<ApiResponse<PostSingleResponse>> updatePost(
            @Header("Authorization") String token,
            @Path("groupId") int groupId,
    ...
    Call<ApiResponse<Void>> deletePost(
            @Path("groupId") int groupId,
            @Path("postId") int postId
    );
    ...
    Call<ApiResponse<PostSingleResponse>> getPost(
            @Path("groupId") int groupId,
            @Path("postId") int postId
    );
