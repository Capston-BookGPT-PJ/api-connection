...
public class LikedUsersAdapter extends RecyclerView.Adapter<LikedUsersAdapter.ViewHolder> {
    ...
    private final List<FeedResponse.LikedUser> likedUsers;

    public LikedUsersAdapter(Context context, List<FeedResponse.LikedUser> likedUsers) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        FeedResponse.LikedUser user = likedUsers.get(position);
