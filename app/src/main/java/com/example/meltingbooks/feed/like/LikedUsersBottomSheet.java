package com.example.meltingbooks.feed.like;
...
public class LikedUsersBottomSheet extends BottomSheetDialogFragment {
    ...
    public static LikedUsersBottomSheet newInstance(List<FeedResponse.LikedUser> likedUsers) {
        LikedUsersBottomSheet fragment = new LikedUsersBottomSheet();
        Bundle args = new Bundle();
        args.putSerializable("likedUsers", (java.io.Serializable) likedUsers);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            likedUsers = (List<FeedResponse.LikedUser>) getArguments().getSerializable("likedUsers");
        }
    }
